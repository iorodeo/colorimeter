...
#
# Created: Mon Apr  9 17:58:25 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.serialPortLineEdit = QtGui.QLineEdit(self.widget)
        ...
        self.serialPortLineEdit.setMaximumSize(QtCore.QSize(140, 16777215))
        self.serialPortLineEdit.setObjectName("serialPortLineEdit")
        self.horizontalLayout.addWidget(self.serialPortLineEdit)
        ...
        self.dataTableWidget = QtGui.QTableWidget(self.frame)
        self.dataTableWidget.setEditTriggers(QtGui.QAbstractItemView.NoEditTriggers)
        ...
        self.horizontalLayout_4.addWidget(self.dataTableWidget)
